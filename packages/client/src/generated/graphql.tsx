...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'AuthResponse', accessToken: string, refreshToken: string, user: { __typename?: 'User', id: string, email: string, firstName: string, lastName: string } } };
...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename?: 'AuthResponse', accessToken: string, refreshToken: string, user: { __typename?: 'User', id: string, email: string, firstName: string, lastName: string } } };
...
export type UpdateSuggestionStatusMutation = { __typename?: 'Mutation', updateSuggestionStatus: { __typename?: 'CommentObjectType', _id: string, text: string, suggestedText?: string | null, status: string, updatedAt: any } };
